...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/snakee.jpg"))); // NOI18N
        ...
        jLabel4.setText("SNAKEGAME - CRUD");
    ...
    void listar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                persona[2] = rs.getString("puntuacion");
    ...
    void Agregar() {
        ...
        try {
            if (nombre.equals("") || puntos.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);               
            } else {
                String sql = "insert into usuarios(nombre,puntuacion) values('" + nombre + "','" + puntos + "')";
                con = cn.getConnection();
                st = con.createStatement();
    ...
    void Agregar1(String nombrex, String puntuacionx) {
        String nombre = nombrex;
        String puntos = puntuacionx;
        try {
            if (nombre.equals("") || puntos.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);               
    ...
    void Modificar() {
        String nombre = txtNombre.getText();
        String puntos = txtPuntos.getText();
        String sql = "update usuarios set nombre='" + nombre + "',puntuacion='" + puntos + "' where id=" + id;
        try {
